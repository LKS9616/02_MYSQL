create database user_db; -- 데이터베이스 생성
...
(
    user_no int not null unique, -- 기본 키
    user_id varchar(255) not null,
    user_pwd varchar(255) not null,
    user_name varchar(255) not null,
    gender varchar(3),
...
-- 같은 내용을 두 번 insert 했을 때, user-no의 unique 키가 중복되게 되면서
...
-- 한 개의 컬럼에 설정할 수도 있고, 여러 개의 컬럼을 묶어서 사용할 수도 있다.
...
/*
참조 무결성
-> 기본키와 외래키 같의 관계가 항상 유지되도록 보장하는 것을 의미한다.
*/
...
insert into user_foreignkey1
(user_no, user_id, user_pwd, user_name, gender, phone, email, grade_code)
values(3, 'user01', 'pass01', '홍길동', '남', '010-1234-5678', 'hon123@gmail.com', 50);
